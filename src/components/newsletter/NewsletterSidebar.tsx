 ...
 * (the /regulations right rail). Same subscribe wiring as NewsletterCTA
 * (POST /api/newsletter/subscribe, honeypot, analytics, states), stacked
 * full-width for the ~350px column. Identical across every page — no per-page
 * content. Replaces the per-page sidebarCta* card.
 */
