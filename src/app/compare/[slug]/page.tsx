...
export default async function ComparePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const contentHeadings = portableTextHeadings(comparison.body);
