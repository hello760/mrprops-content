          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div className="space-y-8 text-center lg:text-left animate-in slide-in-from-left-5 duration-700">
                <Badge variant="outline" className="bg-primary/10 text-primary border-primary/20 px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-wider mx-auto lg:mx-0 w-fit">{page.heroBadge || "Feature"}</Badge>
              ...
              <div className="relative animate-in zoom-in-95 duration-1000 delay-200 w-full">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border/50 bg-card group ring-1 ring-border/50">
                  <div className="bg-muted/50 border-b border-border p-3 flex items-center gap-2"><div className="flex gap-1.5"><div className="w-3 h-3 rounded-full bg-red-400/80" /><div className="w-3 h-3 rounded-full bg-yellow-400/80" /><div className="w-3 h-3 rounded-full bg-green-400/80" /></div><div className="mx-auto bg-background/50 px-3 py-1 rounded text-[10px] font-mono text-muted-foreground w-1/2 text-center truncate">app.mrprops.io/features/{slug}</div></div>
