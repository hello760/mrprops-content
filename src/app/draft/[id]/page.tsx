...
export default async function DraftPreviewPage({
                  ...
                  <div className="bg-card border border-border p-6 rounded-xl shadow-sm">
                    ...
                    <ul className="space-y-3">
                      {related.map((r, i) => {
                        ...
                        const termStr = typeof r === "string" ? r : r?.term;
                        const relationshipStr = typeof r === "string" ? undefined : r?.relationship;
  ...
  if (fam.family === 'landing_page') {
    ...
    const page: any = {
      ...
      // CC↔Live truth fix (2026-05-19, Phase 4): mirror content-pages.ts —
      // no hardcoded section titles in the draft preview either. Draft must
      // show the same render as live so the team can audit before publish.
